...
var n=null
return g(r)?n=r:"string"==typeof r&&r&&(n=S(this.resolver,r,this.meta)),n=this.curry(n),this.lastValue=r,this.lastDefinition=n,n},e.prototype.get=function(){return p},e.prototype.curry=function(e){var t=this.args
return!t&&g(e)?e:e?new _(e,t):null},e}()
function A(e){return M(e)?"":String(e)}function M(e){return null===e||void 0===e||"function"!=typeof e.toString}function j(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function N(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function I(e){return N(e)&&11===e.nodeType}function D(e){return"string"==typeof e}var L=function(){function e(e){this.list=e,this.tag=(0,i.combineTagged)(e),this.list=e}return e.prototype.value=function(){var e,t,r=[],n=this.list
...
d=o.getDynamicLayout(l,a)}u.push(d.symbolTable),u.push(d.handle)}),s.add(56,function(e,t){var r=t.op1,n=e.stack.pop(),i=e.stack.pop(),o=n.manager,s={definition:n,manager:o,capabilities:F(o.getCapabilities(n.state)),state:null,handle:i.handle,table:i.symbolTable}
...
return"attr"===s?Re(n,a,i):function(e,t,r){if(we(e,t))return new Ae(t,r)
...
return new Te(t,r)}(n,a,i)}function Re(e,t,r){return we(e,t)?new Me(r):new Se(r)}var Pe=function(e){this.attribute=e},Se=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(e,t){var r,n,i,o=Ie(t)
...
r?t.removeAttributeNS(r,this.normalizedName):t.removeAttribute(this.normalizedName)},r}(Pe),Ae=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(t,r,n){var i=this.attribute,o=xe(n,i.element,i.name,r)
e.prototype.set.call(this,t,o,n)},r.prototype.update=function(t,r){var n=this.attribute,i=xe(r,n.element,n.name,t)
e.prototype.update.call(this,i,r)},r}(Te),Me=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(t,r,n){var i=this.attribute,o=xe(n,i.element,i.name,r)
e.prototype.set.call(this,t,o,n)},r.prototype.update=function(t,r){var n=this.attribute,i=xe(r,n.element,n.name,t)
e.prototype.update.call(this,i,r)},r}(Se),je=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(e,t){e.__setProperty("value",A(t))},r.prototype.update=function(e){var t=this.attribute.element,r=t.value,n=A(e)
r!==n&&(t.value=n)},r}(Te),Ne=function(e){function r(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(r,e),r.prototype.set=function(e,t){null!==t&&void 0!==t&&!1!==t&&e.__setProperty("selected",!0)},r.prototype.update=function(e){var t=this.attribute.element
t.selected=!!e},r}(Te)
...
if(null!==n){if((t=n.openBlockDepth)>=n.startingBlockDepth)for(;r&&(!Ot(r)||Rt(r)!==t);)r=this.remove(r)
...
this.blockDepth--
var r=e.candidate
null!==r&&(Ot(r)&&Rt(r)===t?(e.candidate=this.remove(r),e.openBlockDepth--):this.clearMismatch(r)),e.openBlockDepth===this.blockDepth&&(e.candidate=this.remove(e.nextSibling),e.openBlockDepth--)}},n.prototype.__appendNode=function(t){var r=this.candidate
...
function Ot(e){return 8===e.nodeType}function Rt(e){var t=e.nodeValue.match(/^%\-b:(\d+)%$/)
return t&&t[1]?Number(t[1]):null}function Pt(e){return 1===e.nodeType}function St(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Tt(e){return 8===e.nodeType&&"% %"===e.nodeValue}function At(e,t){var r,n
...
return new xt(r,n)},e.LowLevelVM=Et,e.UpdatingVM=it,e.RenderResult=ct,e.SimpleDynamicAttribute=Se,e.DynamicAttribute=Pe,e.EMPTY_ARGS=_t,e.Scope=De,e.Environment=Fe,e.DefaultEnvironment=ze,e.DEFAULT_CAPABILITIES={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!1,elementHook:!1},e.MINIMAL_CAPABILITIES={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1},e.CurriedComponentDefinition=_,e.isCurriedComponentDefinition=g,e.curry=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
...
var n,i=t.owner,o=yr(t.moduleName),s=i.factoryFor("helper:"+e,o)||i.factoryFor("helper:"+e)
